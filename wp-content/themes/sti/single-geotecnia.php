<?php require_header(); ?>	
				...
				<div class="single-container relative">
					...
					<div class="page-bar white uppercase txt-right background-yellow">
						<div class="float-left">
						<?php the_title(); ?>
						</div>
						<a class="bar-menu-link uppercase txt-right float-right white ChaletBook-regular" href="<?php echo get_post_type_archive_link ( 'geotecnia' ); ?>">[Regresar a proyectos]</a>
						<div class="clear"></div>
					</div>
